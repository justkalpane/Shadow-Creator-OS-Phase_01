# SKL-PH2C-M-129-NEWSLETTER_SCRIPT_GENERATOR

## 1. Skill Identity
- Skill ID: M-129
- Skill Name: Newsletter Script Generator
- Legacy Alias (Filename Compatibility): Thumbnail Heatmap Analyzer
...
## 2. Purpose
Generate newsletter-ready script variants with editorial framing, segment personalization, and archive metadata.

## 3. DNA Injection
- Archetype: Vyasa (curation organizer)
...
- Platform Specifics: editorial voice consistency, segment-specific blocks, sponsor integration windows

## 4. Workflow Injection
- Producer Workflow: CWF-230
- Consumer Workflows: CWF-240
- Upstream Dependencies: base_script (from M-110/M-120), creator_voice, audience_profile (from M-002)
...
STEP 3: Load deterministic platform contract for Newsletter Script Generator.
...
STEP 8: Assemble typed output packet newsletter_packet and validate against JSON schema.
STEP 9: Append packet to dossier.script_vein.newsletter_script_generator and append lineage row to se_packet_index.
STEP 10: Emit routing decision (success, replay, escalate) with deterministic next-hop references.

## 7. Outputs
- Output Packet Family: newsletter_packet
- JSON Schema Reference: schemas/packets/newsletter_packet.schema.json
- Dossier Write Target: dossier.script_vein.newsletter_script_generator
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-129-[timestamp]-[instance]",
  "artifact_family": "newsletter_packet",
  ...
  "payload": {
    "skill_id": "M-129",
    "skill_name": "Newsletter Script Generator",
    "platform": "Newsletter",
    "primary_output": {
      "newsletter_body": "[platform-adapted artifact]"
    },
    "variants": [
...
- Never mutate dossier fields outside dossier.script_vein.newsletter_script_generator.
