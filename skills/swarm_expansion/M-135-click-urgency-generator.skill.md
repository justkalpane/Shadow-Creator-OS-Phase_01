# SKL-PH1-CLICK-URGENCY-GENERATOR

## 1. Skill Identity
- **Skill ID:** M-135
- **Skill Name:** Click Urgency Generator
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-135 (Click Urgency Generator), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** click-urgency-generator_executor
- **DNA Archetype:** Indra
...
- **Downstream Handoff:** click-urgency-generator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-135
...
```json
{
  "instance_id": "M-135-[timestamp]",
  "artifact_family": "click-urgency-generator_packet",
  ...
  "payload": {
    "skill_id": "M-135",
    "skill_name": "Click Urgency Generator",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.expansion_vein.click-urgency-generator (append_to_array)
...
**Writes:**
- dossier.expansion_vein.click-urgency-generator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M135-001: valid input produces CREATED packet
- TEST-PH1-M135-002: invalid input escalates to WF-900
- TEST-PH1-M135-003: dossier patch is additive only
