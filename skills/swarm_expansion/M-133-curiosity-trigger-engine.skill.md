# SKL-PH1-CURIOSITY-TRIGGER-ENGINE

## 1. Skill Identity
- **Skill ID:** M-133
- **Skill Name:** Curiosity Trigger Engine
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-133 (Curiosity Trigger Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** curiosity-trigger-engine_executor
- **DNA Archetype:** Indra
...
- **Downstream Handoff:** curiosity-trigger-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-133
...
```json
{
  "instance_id": "M-133-[timestamp]",
  "artifact_family": "curiosity-trigger-engine_packet",
  ...
  "payload": {
    "skill_id": "M-133",
    "skill_name": "Curiosity Trigger Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.expansion_vein.curiosity-trigger-engine (append_to_array)
...
**Writes:**
- dossier.expansion_vein.curiosity-trigger-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M133-001: valid input produces CREATED packet
- TEST-PH1-M133-002: invalid input escalates to WF-900
- TEST-PH1-M133-003: dossier patch is additive only
