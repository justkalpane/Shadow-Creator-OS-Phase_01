# SKL-PH2C-M-128-SOCIAL_MEDIA_CAPTION_GENERATOR

## 1. Skill Identity
- Skill ID: M-128
- Skill Name: Social Media Caption Generator
- Legacy Alias (Filename Compatibility): Viral Pattern Replicator
...
## 2. Purpose
Generate platform-specific captions for Instagram, Twitter/X, and Facebook from one source script.

## 3. DNA Injection
- Archetype: Narada (platform-native speaker)
...
- Platform Specifics: platform-specific character norms, hashtag strategy, emoji and CTA adaptation

## 4. Workflow Injection
- Producer Workflow: CWF-230
- Consumer Workflows: CWF-240
- Upstream Dependencies: base_script (from M-110/M-120), creator_voice_profile, platform_constraints.social
...
STEP 3: Load deterministic platform contract for Social Media Caption Generator.
...
STEP 8: Assemble typed output packet social_media_packet and validate against JSON schema.
STEP 9: Append packet to dossier.script_vein.social_media_caption_generator and append lineage row to se_packet_index.
...
~~~json
{
  "instance_id": "M-128-[timestamp]-[instance]",
  "artifact_family": "social_media_packet",
  ...
  "payload": {
    "skill_id": "M-128",
    "skill_name": "Social Media Caption Generator",
    "platform": "Social Media",
    "primary_output": {
      "platform_captions": "[platform-adapted artifact]"
    },
    "variants": [
...
- Never mutate dossier fields outside dossier.script_vein.social_media_caption_generator.
