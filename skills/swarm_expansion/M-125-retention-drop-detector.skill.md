# SKL-PH2C-M-125-LINKEDIN_ARTICLE_GENERATOR

## 1. Skill Identity
- Skill ID: M-125
- Skill Name: LinkedIn Article Generator
- Legacy Alias (Filename Compatibility): Retention Drop Detector
...
## 2. Purpose
Generate professional LinkedIn article variants (short and extended) with authority signals and engagement seeding.

## 3. DNA Injection
- Archetype: Krishna (professional positioning)
...
- Platform Specifics: professional tone, 1-2 minute read plus optional long-form, hashtag and comment-seeding strategy

## 4. Workflow Injection
- Producer Workflow: CWF-230
- Consumer Workflows: CWF-240
- Upstream Dependencies: base_script (from M-110/M-120), creator_profile, platform_constraints.linkedin
...
STEP 3: Load deterministic platform contract for LinkedIn Article Generator.
...
STEP 8: Assemble typed output packet linkedin_packet and validate against JSON schema.
STEP 9: Append packet to dossier.script_vein.linkedin_article_generator and append lineage row to se_packet_index.
...
~~~json
{
  "instance_id": "M-125-[timestamp]-[instance]",
  "artifact_family": "linkedin_packet",
  ...
  "payload": {
    "skill_id": "M-125",
    "skill_name": "LinkedIn Article Generator",
    "platform": "LinkedIn",
    "primary_output": {
      "article_text": "[platform-adapted artifact]"
    },
    "variants": [
...
- Never mutate dossier fields outside dossier.script_vein.linkedin_article_generator.
