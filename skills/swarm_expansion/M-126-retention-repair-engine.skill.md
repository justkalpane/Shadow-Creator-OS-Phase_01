# SKL-PH1-RETENTION-REPAIR-ENGINE

## 1. Skill Identity
- **Skill ID:** M-126
- **Skill Name:** Retention Repair Engine
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-126 (Retention Repair Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** retention-repair-engine_executor
- **DNA Archetype:** Indra
...
- **Downstream Handoff:** retention-repair-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-126
...
```json
{
  "instance_id": "M-126-[timestamp]",
  "artifact_family": "retention-repair-engine_packet",
  ...
  "payload": {
    "skill_id": "M-126",
    "skill_name": "Retention Repair Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.expansion_vein.retention-repair-engine (append_to_array)
...
**Writes:**
- dossier.expansion_vein.retention-repair-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M126-001: valid input produces CREATED packet
- TEST-PH1-M126-002: invalid input escalates to WF-900
- TEST-PH1-M126-003: dossier patch is additive only
