# SKL-PH2C-M-123-BLOG_ARTICLE_GENERATOR

## 1. Skill Identity
- Skill ID: M-123
- Skill Name: Blog Article Generator
- Legacy Alias (Filename Compatibility): Algorithm Pattern Analyzer
...
## 2. Purpose
Convert script to an 800-2000 word blog article with scannable hierarchy, SEO scaffolding, and accessible readability.

## 3. DNA Injection
- Archetype: Saraswati (comprehensive knowledge)
...
- Platform Specifics: 800-2000 words, structured headers, internal-link and CTA slots, readability-first flow

## 4. Workflow Injection
- Producer Workflow: CWF-230
- Consumer Workflows: CWF-240
- Upstream Dependencies: base_script (from M-110/M-120), research_narrative (from M-018), creator_voice_profile
...
STEP 3: Load deterministic platform contract for Blog Article Generator.
...
STEP 8: Assemble typed output packet blog_article_packet and validate against JSON schema.
STEP 9: Append packet to dossier.script_vein.blog_article_generator and append lineage row to se_packet_index.
STEP 10: Emit routing decision (success, replay, escalate) with deterministic next-hop references.

## 7. Outputs
- Output Packet Family: blog_article_packet
- JSON Schema Reference: schemas/packets/blog_article_packet.schema.json
- Dossier Write Target: dossier.script_vein.blog_article_generator
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-123-[timestamp]-[instance]",
  "artifact_family": "blog_article_packet",
  ...
  "payload": {
    "skill_id": "M-123",
    "skill_name": "Blog Article Generator",
    "platform": "Blog",
    "primary_output": {
      "full_article_text": "[platform-adapted artifact]"
    },
    "variants": [
...
- Never mutate dossier fields outside dossier.script_vein.blog_article_generator.
