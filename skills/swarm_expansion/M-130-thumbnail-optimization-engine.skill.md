# SKL-PH1-THUMBNAIL-OPTIMIZATION-ENGINE

## 1. Skill Identity
- **Skill ID:** M-130
- **Skill Name:** Thumbnail Optimization Engine
- **Version:** 1.0.0
...
- **Vein/Route/Stage:** expansion_vein / topic_to_script / Stage_E_Expansion

## 2. Purpose
Replica skill artifact for M-130 (Thumbnail Optimization Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** thumbnail-optimization-engine_executor
- **DNA Archetype:** Indra
...
- **Downstream Handoff:** thumbnail-optimization-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-130
...
```json
{
  "instance_id": "M-130-[timestamp]",
  "artifact_family": "thumbnail-optimization-engine_packet",
  ...
  "payload": {
    "skill_id": "M-130",
    "skill_name": "Thumbnail Optimization Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.expansion_vein.thumbnail-optimization-engine (append_to_array)
- se_packet_index (single index row)

## 8. Governance
- **Director Binding:** Indra (owner), Krishna (strategic authority)
- **Veto Power:** no
...
**Writes:**
- dossier.expansion_vein.thumbnail-optimization-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M130-001: valid input produces CREATED packet
- TEST-PH1-M130-002: invalid input escalates to WF-900
- TEST-PH1-M130-003: dossier patch is additive only
