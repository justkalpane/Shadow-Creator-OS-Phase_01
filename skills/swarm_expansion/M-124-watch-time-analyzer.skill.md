# SKL-PH2C-M-124-PODCAST_SCRIPT_GENERATOR

## 1. Skill Identity
- Skill ID: M-124
- Skill Name: Podcast Script Generator
- Legacy Alias (Filename Compatibility): Watch-Time Analyzer
...
## 2. Purpose
Adapt script into a 15-45 minute podcast format with conversational rhythm, pause markers, and production notes.

## 3. DNA Injection
- Archetype: Narada (conversational facilitator)
...
- Platform Specifics: 15-45 minute audio-first format, host-listener conversational tone, pause and segue annotations

## 4. Workflow Injection
- Producer Workflow: CWF-230
- Consumer Workflows: CWF-240
- Upstream Dependencies: base_script (from M-110/M-120), creator_voice_profile, platform_constraints.podcast
...
STEP 3: Load deterministic platform contract for Podcast Script Generator.
...
STEP 8: Assemble typed output packet podcast_script_packet and validate against JSON schema.
STEP 9: Append packet to dossier.script_vein.podcast_script_generator and append lineage row to se_packet_index.
...
~~~json
{
  "instance_id": "M-124-[timestamp]-[instance]",
  "artifact_family": "podcast_script_packet",
  ...
  "payload": {
    "skill_id": "M-124",
    "skill_name": "Podcast Script Generator",
    "platform": "Podcast",
    "primary_output": {
      "conversational_script": "[platform-adapted artifact]"
    },
    "variants": [
...
- Never mutate dossier fields outside dossier.script_vein.podcast_script_generator.
