# SKL-PH1-ALGORITHM-INTELLIGENCE-CORE

## 1. Skill Identity
- **Skill ID:** M-121
- **Skill Name:** Algorithm Intelligence Core
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-121 (Algorithm Intelligence Core), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** algorithm-intelligence-core_executor
- **DNA Archetype:** Indra
...
- **Downstream Handoff:** algorithm-intelligence-core_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-121
...
```json
{
  "instance_id": "M-121-[timestamp]",
  "artifact_family": "algorithm-intelligence-core_packet",
  ...
  "payload": {
    "skill_id": "M-121",
    "skill_name": "Algorithm Intelligence Core",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.expansion_vein.algorithm-intelligence-core (append_to_array)
...
**Writes:**
- dossier.expansion_vein.algorithm-intelligence-core (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M121-001: valid input produces CREATED packet
- TEST-PH1-M121-002: invalid input escalates to WF-900
- TEST-PH1-M121-003: dossier patch is additive only
