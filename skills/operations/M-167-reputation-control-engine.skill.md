# SKL-PH1-REPUTATION-CONTROL-ENGINE

## 1. Skill Identity
- **Skill ID:** M-167
- **Skill Name:** Reputation Control Engine
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-167 (Reputation Control Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** reputation-control-engine_executor
...
- **Downstream Handoff:** reputation-control-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-167
...
```json
{
  "instance_id": "M-167-[timestamp]",
  "artifact_family": "reputation-control-engine_packet",
  ...
  "payload": {
    "skill_id": "M-167",
    "skill_name": "Reputation Control Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.reputation-control-engine (append_to_array)
...
**Writes:**
- dossier.operations_vein.reputation-control-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M167-001: valid input produces CREATED packet
- TEST-PH1-M167-002: invalid input escalates to WF-900
- TEST-PH1-M167-003: dossier patch is additive only
