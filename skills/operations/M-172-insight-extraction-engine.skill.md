# SKL-PH1-INSIGHT-EXTRACTION-ENGINE

## 1. Skill Identity
- **Skill ID:** M-172
- **Skill Name:** Insight Extraction Engine
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-172 (Insight Extraction Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** insight-extraction-engine_executor
...
- **Downstream Handoff:** insight-extraction-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-172
...
```json
{
  "instance_id": "M-172-[timestamp]",
  "artifact_family": "insight-extraction-engine_packet",
  ...
  "payload": {
    "skill_id": "M-172",
    "skill_name": "Insight Extraction Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.insight-extraction-engine (append_to_array)
...
**Writes:**
- dossier.operations_vein.insight-extraction-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M172-001: valid input produces CREATED packet
- TEST-PH1-M172-002: invalid input escalates to WF-900
- TEST-PH1-M172-003: dossier patch is additive only
