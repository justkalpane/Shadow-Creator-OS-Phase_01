# SKL-PH1-CREATOR-IDENTITY-MANAGER

## 1. Skill Identity
- **Skill ID:** M-166
- **Skill Name:** Creator Identity Manager
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-166 (Creator Identity Manager), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** creator-identity-manager_executor
...
- **Downstream Handoff:** creator-identity-manager_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-166
...
```json
{
  "instance_id": "M-166-[timestamp]",
  "artifact_family": "creator-identity-manager_packet",
  ...
  "payload": {
    "skill_id": "M-166",
    "skill_name": "Creator Identity Manager",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.creator-identity-manager (append_to_array)
...
**Writes:**
- dossier.operations_vein.creator-identity-manager (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M166-001: valid input produces CREATED packet
- TEST-PH1-M166-002: invalid input escalates to WF-900
- TEST-PH1-M166-003: dossier patch is additive only
