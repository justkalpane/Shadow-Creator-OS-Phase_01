...
## 2. Purpose
Skill artifact for M-171 (Knowledge Graph Builder), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.
...
3. Execute core transformation logic for M-171
...
```
**Write Targets:**
- dossier.operations_vein.knowledge-graph-builder (append_to_array)
...
**Writes:**
- dossier.operations_vein.knowledge-graph-builder (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M171-001: valid input produces CREATED packet
- TEST-PH1-M171-002: invalid input escalates to WF-900
- TEST-PH1-M171-003: dossier patch is additive only
