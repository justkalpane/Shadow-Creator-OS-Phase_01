# SKL-PH1-AUDIENCE-PERSONA-GENERATOR

## 1. Skill Identity
- **Skill ID:** M-156
- **Skill Name:** Audience Persona Generator
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-156 (Audience Persona Generator), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** audience-persona-generator_executor
...
- **Downstream Handoff:** audience-persona-generator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-156
...
```json
{
  "instance_id": "M-156-[timestamp]",
  "artifact_family": "audience-persona-generator_packet",
  ...
  "payload": {
    "skill_id": "M-156",
    "skill_name": "Audience Persona Generator",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.audience-persona-generator (append_to_array)
...
**Writes:**
- dossier.operations_vein.audience-persona-generator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M156-001: valid input produces CREATED packet
- TEST-PH1-M156-002: invalid input escalates to WF-900
- TEST-PH1-M156-003: dossier patch is additive only
