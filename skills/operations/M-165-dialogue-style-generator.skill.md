# SKL-PH1-DIALOGUE-STYLE-GENERATOR

## 1. Skill Identity
- **Skill ID:** M-165
- **Skill Name:** Dialogue Style Generator
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-165 (Dialogue Style Generator), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** dialogue-style-generator_executor
...
- **Downstream Handoff:** dialogue-style-generator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-165
...
```json
{
  "instance_id": "M-165-[timestamp]",
  "artifact_family": "dialogue-style-generator_packet",
  ...
  "payload": {
    "skill_id": "M-165",
    "skill_name": "Dialogue Style Generator",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.dialogue-style-generator (append_to_array)
...
**Writes:**
- dossier.operations_vein.dialogue-style-generator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M165-001: valid input produces CREATED packet
- TEST-PH1-M165-002: invalid input escalates to WF-900
- TEST-PH1-M165-003: dossier patch is additive only
