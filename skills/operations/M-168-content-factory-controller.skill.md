# SKL-PH1-CONTENT-FACTORY-CONTROLLER

## 1. Skill Identity
- **Skill ID:** M-168
- **Skill Name:** Content Factory Controller
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-168 (Content Factory Controller), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** content-factory-controller_executor
...
- **Downstream Handoff:** content-factory-controller_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-168
...
```json
{
  "instance_id": "M-168-[timestamp]",
  "artifact_family": "content-factory-controller_packet",
  ...
  "payload": {
    "skill_id": "M-168",
    "skill_name": "Content Factory Controller",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.operations_vein.content-factory-controller (append_to_array)
...
**Writes:**
- dossier.operations_vein.content-factory-controller (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M168-001: valid input produces CREATED packet
- TEST-PH1-M168-002: invalid input escalates to WF-900
- TEST-PH1-M168-003: dossier patch is additive only
