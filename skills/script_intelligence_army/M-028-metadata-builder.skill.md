# SKL-PH1-METADATA-BUILDER

## 1. Skill Identity
- **Skill ID:** M-028
- **Skill Name:** Metadata Builder
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-028 (Metadata Builder), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** metadata-builder_executor
...
- **Downstream Handoff:** metadata-builder_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-028
...
```json
{
  "instance_id": "M-028-[timestamp]",
  "artifact_family": "metadata-builder_packet",
  ...
  "payload": {
    "skill_id": "M-028",
    "skill_name": "Metadata Builder",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.narrative_vein.metadata-builder (append_to_array)
...
**Writes:**
- dossier.narrative_vein.metadata-builder (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M028-001: valid input produces CREATED packet
- TEST-PH1-M028-002: invalid input escalates to WF-900
- TEST-PH1-M028-003: dossier patch is additive only
