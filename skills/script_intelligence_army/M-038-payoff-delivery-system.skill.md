# SKL-PH1-PAYOFF-DELIVERY-SYSTEM

## 1. Skill Identity
- **Skill ID:** M-038
- **Skill Name:** Payoff Delivery System
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-038 (Payoff Delivery System), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** payoff-delivery-system_executor
...
- **Downstream Handoff:** payoff-delivery-system_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-038
...
```json
{
  "instance_id": "M-038-[timestamp]",
  "artifact_family": "payoff-delivery-system_packet",
  ...
  "payload": {
    "skill_id": "M-038",
    "skill_name": "Payoff Delivery System",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.narrative_vein.payoff-delivery-system (append_to_array)
...
**Writes:**
- dossier.narrative_vein.payoff-delivery-system (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M038-001: valid input produces CREATED packet
- TEST-PH1-M038-002: invalid input escalates to WF-900
- TEST-PH1-M038-003: dossier patch is additive only
