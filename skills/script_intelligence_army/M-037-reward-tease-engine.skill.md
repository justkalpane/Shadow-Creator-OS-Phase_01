# SKL-PH1-REWARD-TEASE-ENGINE

## 1. Skill Identity
- **Skill ID:** M-037
- **Skill Name:** Reward Tease Engine
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-037 (Reward Tease Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** reward-tease-engine_executor
...
- **Downstream Handoff:** reward-tease-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-037
...
```
**Write Targets:**
- dossier.narrative_vein.reward-tease-engine (append_to_array)
...
**Writes:**
- dossier.narrative_vein.reward-tease-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M037-001: valid input produces CREATED packet
- TEST-PH1-M037-002: invalid input escalates to WF-900
- TEST-PH1-M037-003: dossier patch is additive only
