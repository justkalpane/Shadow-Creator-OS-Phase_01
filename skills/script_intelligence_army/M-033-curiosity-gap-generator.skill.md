# SKL-PH1-CURIOSITY-GAP-GENERATOR

## 1. Skill Identity
- **Skill ID:** M-033
- **Skill Name:** Curiosity Gap Generator
- **Version:** 1.0.0
...
## 2. Purpose
Replica skill artifact for M-033 (Curiosity Gap Generator), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** curiosity-gap-generator_executor
...
- **Downstream Handoff:** curiosity-gap-generator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-033
...
```json
{
  "instance_id": "M-033-[timestamp]",
  "artifact_family": "curiosity-gap-generator_packet",
  ...
  "payload": {
    "skill_id": "M-033",
    "skill_name": "Curiosity Gap Generator",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.narrative_vein.curiosity-gap-generator (append_to_array)
...
**Writes:**
- dossier.narrative_vein.curiosity-gap-generator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M033-001: valid input produces CREATED packet
- TEST-PH1-M033-002: invalid input escalates to WF-900
- TEST-PH1-M033-003: dossier patch is additive only
