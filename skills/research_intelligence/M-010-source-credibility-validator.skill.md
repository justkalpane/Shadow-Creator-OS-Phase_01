# SKL-PH1-SOURCE-CREDIBILITY-VALIDATOR

## 1. Skill Identity
- **Skill ID:** M-010
- **Skill Name:** Source Credibility Validator
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-010 (Source Credibility Validator). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** source-credibility-validator_executor
- **DNA Archetype:** Vyasa
...
- **Downstream Handoff:** source-credibility-validator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-010
...
```json
{
  "instance_id": "M-010-[timestamp]",
  "artifact_family": "source-credibility-validator_packet",
  ...
  "payload": {
    "skill_id": "M-010",
    "skill_name": "Source Credibility Validator",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.research_vein.source-credibility-validator (append_to_array)
...
**Writes:**
- dossier.research_vein.source-credibility-validator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M010-001: valid input produces CREATED packet
- TEST-PH1-M010-002: invalid input escalates to WF-900
- TEST-PH1-M010-003: dossier patch is additive only
