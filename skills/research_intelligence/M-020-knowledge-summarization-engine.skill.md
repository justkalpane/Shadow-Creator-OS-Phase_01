# SKL-PH1-KNOWLEDGE-SUMMARIZATION-ENGINE

## 1. Skill Identity
- **Skill ID:** M-020
- **Skill Name:** Knowledge Summarization Engine
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-020 (Knowledge Summarization Engine). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** knowledge-summarization-engine_executor
- **DNA Archetype:** Vyasa
...
- **Downstream Handoff:** knowledge-summarization-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-020
...
**Write Targets:**
- dossier.research_vein.knowledge-summarization-engine (append_to_array)
...
**Writes:**
- dossier.research_vein.knowledge-summarization-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M020-001: valid input produces CREATED packet
- TEST-PH1-M020-002: invalid input escalates to WF-900
- TEST-PH1-M020-003: dossier patch is additive only
