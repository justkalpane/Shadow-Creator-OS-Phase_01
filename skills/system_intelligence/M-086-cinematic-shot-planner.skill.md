# SKL-PH1-CINEMATIC-SHOT-PLANNER

## 1. Skill Identity
- **Skill ID:** M-086
- **Skill Name:** Cinematic Shot Planner
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-086 (Cinematic Shot Planner), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** cinematic-shot-planner_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** cinematic-shot-planner_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-086
...
```json
{
  "instance_id": "M-086-[timestamp]",
  "artifact_family": "cinematic-shot-planner_packet",
  ...
  "payload": {
    "skill_id": "M-086",
    "skill_name": "Cinematic Shot Planner",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.runtime_vein.cinematic-shot-planner (append_to_array)
...
**Writes:**
- dossier.runtime_vein.cinematic-shot-planner (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M086-001: valid input produces CREATED packet
- TEST-PH1-M086-002: invalid input escalates to WF-900
- TEST-PH1-M086-003: dossier patch is additive only
