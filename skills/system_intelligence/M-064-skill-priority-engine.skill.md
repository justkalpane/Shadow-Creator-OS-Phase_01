# SKL-PH1-SKILL-PRIORITY-ENGINE

## 1. Skill Identity
- **Skill ID:** M-064
- **Skill Name:** Skill Priority Engine
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-064 (Skill Priority Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** skill-priority-engine_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** skill-priority-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-064
...
```json
{
  "instance_id": "M-064-[timestamp]",
  "artifact_family": "skill-priority-engine_packet",
  ...
  "payload": {
    "skill_id": "M-064",
    "skill_name": "Skill Priority Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.runtime_vein.skill-priority-engine (append_to_array)
...
**Writes:**
- dossier.runtime_vein.skill-priority-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M064-001: valid input produces CREATED packet
- TEST-PH1-M064-002: invalid input escalates to WF-900
- TEST-PH1-M064-003: dossier patch is additive only
