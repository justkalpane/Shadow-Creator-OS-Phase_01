# SKL-PH1-SOCIAL-MEDIA-DISTRIBUTOR

## 1. Skill Identity
- **Skill ID:** M-083
- **Skill Name:** Social Media Distributor
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-083 (Social Media Distributor), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** social-media-distributor_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** social-media-distributor_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-083
...
```json
{
  "instance_id": "M-083-[timestamp]",
  "artifact_family": "social-media-distributor_packet",
  ...
  "payload": {
    "skill_id": "M-083",
    "skill_name": "Social Media Distributor",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.runtime_vein.social-media-distributor (append_to_array)
...
**Writes:**
- dossier.runtime_vein.social-media-distributor (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M083-001: valid input produces CREATED packet
- TEST-PH1-M083-002: invalid input escalates to WF-900
- TEST-PH1-M083-003: dossier patch is additive only
