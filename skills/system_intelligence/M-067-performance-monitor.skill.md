# SKL-PH1-PERFORMANCE-MONITOR

## 1. Skill Identity
- **Skill ID:** M-067
- **Skill Name:** Performance Monitor
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-067 (Performance Monitor), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** performance-monitor_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** performance-monitor_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-067
...
```json
{
  "instance_id": "M-067-[timestamp]",
  "artifact_family": "performance-monitor_packet",
...
```
**Write Targets:**
- dossier.runtime_vein.performance-monitor (append_to_array)
...
**Writes:**
- dossier.runtime_vein.performance-monitor (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M067-001: valid input produces CREATED packet
- TEST-PH1-M067-002: invalid input escalates to WF-900
- TEST-PH1-M067-003: dossier patch is additive only
