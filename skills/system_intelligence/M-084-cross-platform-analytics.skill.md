# SKL-PH1-CROSS-PLATFORM-ANALYTICS
...
## 2. Purpose
Skill artifact for M-084 (Cross-Platform Analytics), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** cross-platform-analytics_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** cross-platform-analytics_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-084
...
```json
{
  "instance_id": "M-084-[timestamp]",
  "artifact_family": "cross-platform-analytics_packet",
  ...
  "payload": {
    "skill_id": "M-084",
    "skill_name": "Cross-Platform Analytics",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.runtime_vein.cross-platform-analytics (append_to_array)
...
**Writes:**
- dossier.runtime_vein.cross-platform-analytics (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M084-001: valid input produces CREATED packet
- TEST-PH1-M084-002: invalid input escalates to WF-900
- TEST-PH1-M084-003: dossier patch is additive only
