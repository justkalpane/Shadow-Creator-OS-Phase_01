# SKL-PH1-RESOURCE-ALLOCATOR

## 1. Skill Identity
- **Skill ID:** M-066
- **Skill Name:** Resource Allocator
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-066 (Resource Allocator), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** resource-allocator_executor
- **DNA Archetype:** Aruna
...
- **Downstream Handoff:** resource-allocator_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-066
...
```json
{
  "instance_id": "M-066-[timestamp]",
  "artifact_family": "resource-allocator_packet",
...
```
**Write Targets:**
- dossier.runtime_vein.resource-allocator (append_to_array)
...
**Writes:**
- dossier.runtime_vein.resource-allocator (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M066-001: valid input produces CREATED packet
- TEST-PH1-M066-002: invalid input escalates to WF-900
- TEST-PH1-M066-003: dossier patch is additive only
