# SKL-PH3C-M-242-PODCAST_INTRO_OUTRO_DESIGNER

## 1. Skill Identity
- Skill ID: M-242
- Skill Name: Podcast Intro or Outro Designer
- Legacy Alias (Compatibility): Transition Sound Designer
- Alias Names: Transition Sound Designer
...
- Upstream Dependencies: editing_sequence (from M-218), sound_design (from M-232)
- Upstream Skill IDs: M-218, M-232
- Downstream Consumers: M-243 Audio Transitions Optimizer
- Downstream Skill IDs: M-243
...
STEP 3: Load deterministic audio policy profile for Podcast Intro or Outro Designer.
...
STEP 5: Generate primary output payload field transition_effects.
...
STEP 8: Assemble typed output packet transition_sound_packet.
STEP 9: Append packet to dossier.media_vein.podcast_intro_outro_designer and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-242-[timestamp]-[instance]",
  "artifact_family": "transition_sound_packet",
  ...
  "payload": {
    "skill_id": "M-242",
    "skill_name": "Podcast Intro or Outro Designer",
    "primary_output": {
      "transition_effects": "[artifact]"
    },
    "routing": {
      "on_success": "M-243",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-242-001: Valid required inputs produce deterministic transition_sound_packet output
- TEST-PH3C-M-242-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-242-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-242-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-242-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-242-006: Primary output field transition_effects is present and non-empty
- TEST-PH3C-M-242-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-242-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-242-009: Dossier writes target only dossier.media_vein.podcast_intro_outro_designer
- TEST-PH3C-M-242-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-242-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-242-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-242-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-242-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-242-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-242-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-242-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-242-018: Acceptance gate fails closed when governance metadata is incomplete
