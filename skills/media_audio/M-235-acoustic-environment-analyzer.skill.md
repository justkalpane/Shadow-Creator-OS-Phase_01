# SKL-PH3C-M-235-ACOUSTIC_ENVIRONMENT_ANALYZER

## 1. Skill Identity
- Skill ID: M-235
- Skill Name: Acoustic Environment Analyzer
- Legacy Alias (Compatibility): Acoustic Environment Analyzer
- Alias Names: none
...
- Upstream Dependencies: production_environment_specs
- Upstream Skill IDs: M-234
- Downstream Consumers: M-236 Noise Reduction Strategy
- Downstream Skill IDs: M-236
...
STEP 3: Load deterministic audio policy profile for Acoustic Environment Analyzer.
...
STEP 5: Generate primary output payload field environment_specifications.
...
STEP 8: Assemble typed output packet acoustics_packet.
STEP 9: Append packet to dossier.media_vein.acoustic_environment_analyzer and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-235-[timestamp]-[instance]",
  "artifact_family": "acoustics_packet",
  ...
  "payload": {
    "skill_id": "M-235",
    "skill_name": "Acoustic Environment Analyzer",
    "primary_output": {
      "environment_specifications": "[artifact]"
    },
    "routing": {
      "on_success": "M-236",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-235-001: Valid required inputs produce deterministic acoustics_packet output
- TEST-PH3C-M-235-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-235-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-235-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-235-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-235-006: Primary output field environment_specifications is present and non-empty
- TEST-PH3C-M-235-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-235-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-235-009: Dossier writes target only dossier.media_vein.acoustic_environment_analyzer
- TEST-PH3C-M-235-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-235-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-235-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-235-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-235-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-235-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-235-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-235-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-235-018: Acceptance gate fails closed when governance metadata is incomplete
