# SKL-PH3C-M-239-REVERB_EFFECTS_DESIGNER

## 1. Skill Identity
- Skill ID: M-239
- Skill Name: Reverb and Effects Designer
- Legacy Alias (Compatibility): Reverb & Spatial Effects Designer
- Alias Names: Reverb & Spatial Effects Designer
...
- Upstream Dependencies: emotional_arc (from M-106), voiceover_spec (from M-231)
- Upstream Skill IDs: M-106, M-231
- Downstream Consumers: M-240 Audio Mixing Guide
- Downstream Skill IDs: M-240
...
STEP 3: Load deterministic audio policy profile for Reverb and Effects Designer.
...
STEP 5: Generate primary output payload field reverb_specifications.
...
STEP 8: Assemble typed output packet reverb_effects_packet.
STEP 9: Append packet to dossier.media_vein.reverb_effects_designer and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-239-[timestamp]-[instance]",
  "artifact_family": "reverb_effects_packet",
  ...
  "payload": {
    "skill_id": "M-239",
    "skill_name": "Reverb and Effects Designer",
    "primary_output": {
      "reverb_specifications": "[artifact]"
    },
    "routing": {
      "on_success": "M-240",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-239-001: Valid required inputs produce deterministic reverb_effects_packet output
- TEST-PH3C-M-239-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-239-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-239-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-239-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-239-006: Primary output field reverb_specifications is present and non-empty
- TEST-PH3C-M-239-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-239-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-239-009: Dossier writes target only dossier.media_vein.reverb_effects_designer
- TEST-PH3C-M-239-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-239-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-239-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-239-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-239-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-239-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-239-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-239-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-239-018: Acceptance gate fails closed when governance metadata is incomplete
