# SKL-PH3C-M-240-AUDIO_MIXING_GUIDE

## 1. Skill Identity
- Skill ID: M-240
- Skill Name: Audio Mixing Guide
- Legacy Alias (Compatibility): Mix & Master Specification
- Alias Names: Mix & Master Specification
...
- Upstream Dependencies: all audio elements (M-231-M-239)
- Upstream Skill IDs: M-231, M-232, M-233, M-234, M-235, M-236, M-237, M-238, M-239
- Downstream Consumers: M-241 Mastering Specifications
- Downstream Skill IDs: M-241
...
STEP 3: Load deterministic audio policy profile for Audio Mixing Guide.
...
STEP 5: Generate primary output payload field mix_balance_specs.
...
STEP 8: Assemble typed output packet mix_master_packet.
STEP 9: Append packet to dossier.media_vein.audio_mixing_guide and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-241 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: mix_master_packet
- JSON Schema Reference: schemas/packets/mix_master_packet.schema.json
- Dossier Write Target: dossier.media_vein.audio_mixing_guide
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-240-[timestamp]-[instance]",
  "artifact_family": "mix_master_packet",
  ...
  "payload": {
    "skill_id": "M-240",
    "skill_name": "Audio Mixing Guide",
    "primary_output": {
      "mix_balance_specs": "[artifact]"
    },
    "routing": {
      "on_success": "M-241",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-240-001: Valid required inputs produce deterministic mix_master_packet output
- TEST-PH3C-M-240-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-240-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-240-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-240-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-240-006: Primary output field mix_balance_specs is present and non-empty
- TEST-PH3C-M-240-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-240-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-240-009: Dossier writes target only dossier.media_vein.audio_mixing_guide
- TEST-PH3C-M-240-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-240-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-240-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-240-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-240-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-240-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-240-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-240-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-240-018: Acceptance gate fails closed when governance metadata is incomplete
