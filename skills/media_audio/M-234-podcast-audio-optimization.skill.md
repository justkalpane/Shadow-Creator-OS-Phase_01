# SKL-PH3C-M-234-PODCAST_AUDIO_OPTIMIZATION

## 1. Skill Identity
- Skill ID: M-234
- Skill Name: Podcast Audio Optimization
- Legacy Alias (Compatibility): Podcast Optimization Engine
- Alias Names: Podcast Optimization Engine
...
- Upstream Dependencies: podcast_script (from M-124), voiceover_specs (from M-231), sound_design (from M-232)
- Upstream Skill IDs: M-124, M-231, M-232
- Downstream Consumers: M-235 Acoustic Environment Analyzer
- Downstream Skill IDs: M-235
...
STEP 3: Load deterministic audio policy profile for Podcast Audio Optimization.
...
STEP 5: Generate primary output payload field podcast_format_specs.
...
STEP 8: Assemble typed output packet podcast_audio_packet.
STEP 9: Append packet to dossier.media_vein.podcast_audio_optimization and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-234-[timestamp]-[instance]",
  "artifact_family": "podcast_audio_packet",
  ...
  "payload": {
    "skill_id": "M-234",
    "skill_name": "Podcast Audio Optimization",
    "primary_output": {
      "podcast_format_specs": "[artifact]"
    },
    "routing": {
      "on_success": "M-235",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-234-001: Valid required inputs produce deterministic podcast_audio_packet output
- TEST-PH3C-M-234-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-234-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-234-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-234-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-234-006: Primary output field podcast_format_specs is present and non-empty
- TEST-PH3C-M-234-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-234-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-234-009: Dossier writes target only dossier.media_vein.podcast_audio_optimization
- TEST-PH3C-M-234-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-234-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-234-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-234-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-234-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-234-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-234-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-234-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-234-018: Acceptance gate fails closed when governance metadata is incomplete
