# SKL-PH3C-M-232-SOUND_DESIGN_BRIEF

## 1. Skill Identity
- Skill ID: M-232
- Skill Name: Sound Design Brief
- Legacy Alias (Compatibility): Sound Design Palette Creator
- Alias Names: Sound Design Palette Creator
...
- Upstream Dependencies: sound_design_brief (from M-220), emotional_arc (from M-106)
- Upstream Skill IDs: M-220, M-106
- Downstream Consumers: M-233 Music Selection Advisor
- Downstream Skill IDs: M-233
...
STEP 3: Load deterministic audio policy profile for Sound Design Brief.
...
STEP 5: Generate primary output payload field ambient_sounds.
...
STEP 8: Assemble typed output packet sound_palette_packet.
STEP 9: Append packet to dossier.media_vein.sound_design_brief and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-233 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: sound_palette_packet
- JSON Schema Reference: schemas/packets/sound_palette_packet.schema.json
- Dossier Write Target: dossier.media_vein.sound_design_brief
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-232-[timestamp]-[instance]",
  "artifact_family": "sound_palette_packet",
  ...
  "payload": {
    "skill_id": "M-232",
    "skill_name": "Sound Design Brief",
    "primary_output": {
      "ambient_sounds": "[artifact]"
    },
    "routing": {
      "on_success": "M-233",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3C-M-232-001: Valid required inputs produce deterministic sound_palette_packet output
- TEST-PH3C-M-232-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3C-M-232-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3C-M-232-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3C-M-232-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3C-M-232-006: Primary output field ambient_sounds is present and non-empty
- TEST-PH3C-M-232-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3C-M-232-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3C-M-232-009: Dossier writes target only dossier.media_vein.sound_design_brief
- TEST-PH3C-M-232-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3C-M-232-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3C-M-232-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3C-M-232-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3C-M-232-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3C-M-232-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3C-M-232-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3C-M-232-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3C-M-232-018: Acceptance gate fails closed when governance metadata is incomplete
