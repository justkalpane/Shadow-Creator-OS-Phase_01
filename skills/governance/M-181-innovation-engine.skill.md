# SKL-PH1-INNOVATION-ENGINE

## 1. Skill Identity
- **Skill ID:** M-181
- **Skill Name:** Innovation Engine
- **Version:** 1.0.0
- **Phase Scope:** PHASE_1_TOPIC_TO_SCRIPT
- **Classification:** github_source_of_truth
- **Owner Workflow:** SE-N8N-WF
- **Consumer Workflows:** WF-900, WF-010
- **Vein/Route/Stage:** sovereign_vein / topic_to_script / Stage_F_Sovereign

## 2. Purpose
Skill artifact for M-181 (Innovation Engine), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** innovation-engine_executor
...
- **Producer:** WF
- **Direct Consumers:** WF-900, WF-010
- **Upstream Dependencies:** workflow_registry, skill_loader_registry, dossier packet context
- **Downstream Handoff:** innovation-engine_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-181
...
```json
{
  "instance_id": "M-181-[timestamp]",
  "artifact_family": "innovation-engine_packet",
  ...
  "payload": {
    "skill_id": "M-181",
    "skill_name": "Innovation Engine",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.sovereign_vein.innovation-engine (append_to_array)
...
**Writes:**
- dossier.sovereign_vein.innovation-engine (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M181-001: valid input produces CREATED packet
- TEST-PH1-M181-002: invalid input escalates to WF-900
- TEST-PH1-M181-003: dossier patch is additive only
