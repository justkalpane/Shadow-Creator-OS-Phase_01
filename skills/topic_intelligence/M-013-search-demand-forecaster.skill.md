# SKL-PH1-SEARCH-DEMAND-FORECASTER
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-013 (Search Demand Forecaster). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** search-demand-forecaster_executor
...
- **Downstream Handoff:** search-demand-forecaster_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-013
...
```json
{
  "instance_id": "M-013-[timestamp]",
  "artifact_family": "search-demand-forecaster_packet",
  ...
  "payload": {
    "skill_id": "M-013",
    "skill_name": "Search Demand Forecaster",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.topic_intelligence_vein.search-demand-forecaster (append_to_array)
...
**Writes:**
- dossier.topic_intelligence_vein.search-demand-forecaster (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M013-001: valid input produces CREATED packet
- TEST-PH1-M013-002: invalid input escalates to WF-900
- TEST-PH1-M013-003: dossier patch is additive only
