# SKL-PH1-AUDIENCE-PAIN-POINT-MINER

## 1. Skill Identity
- **Skill ID:** M-019
- **Skill Name:** Audience Pain-Point Miner
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-019 (Audience Pain-Point Miner). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** audience-pain-point-miner_executor
...
- **Downstream Handoff:** audience-pain-point-miner_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-019
...
```json
{
  "instance_id": "M-019-[timestamp]",
  "artifact_family": "audience-pain-point-miner_packet",
  ...
  "payload": {
    "skill_id": "M-019",
    "skill_name": "Audience Pain-Point Miner",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.topic_intelligence_vein.audience-pain-point-miner (append_to_array)
...
**Writes:**
- dossier.topic_intelligence_vein.audience-pain-point-miner (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M019-001: valid input produces CREATED packet
- TEST-PH1-M019-002: invalid input escalates to WF-900
- TEST-PH1-M019-003: dossier patch is additive only
