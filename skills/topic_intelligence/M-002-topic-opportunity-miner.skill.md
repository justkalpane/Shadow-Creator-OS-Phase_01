...
3. Execute core transformation logic for M-002
...
**Write Targets:**
- dossier.discovery_vein.topic-opportunity-miner (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M002-001: valid input produces CREATED packet
- TEST-PH1-M002-002: invalid input escalates to WF-900
- TEST-PH1-M002-003: dossier patch is additive only
