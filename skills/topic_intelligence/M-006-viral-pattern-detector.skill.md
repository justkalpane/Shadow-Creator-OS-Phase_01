...
3. Execute core transformation logic for M-006
...
**Write Targets:**
- dossier.topic_intelligence_vein.viral-pattern-detector (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M006-001: valid input produces CREATED packet
- TEST-PH1-M006-002: invalid input escalates to WF-900
- TEST-PH1-M006-003: dossier patch is additive only
