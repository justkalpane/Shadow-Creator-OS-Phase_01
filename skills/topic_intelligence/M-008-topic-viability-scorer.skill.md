...
3. Execute core transformation logic for M-008
...
**Write Targets:**
- dossier.topic_intelligence_vein.topic-viability-scorer (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M008-001: valid input produces CREATED packet
- TEST-PH1-M008-002: invalid input escalates to WF-900
- TEST-PH1-M008-003: dossier patch is additive only
