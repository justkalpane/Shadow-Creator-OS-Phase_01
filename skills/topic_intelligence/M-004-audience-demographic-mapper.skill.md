...
3. Execute core transformation logic for M-004
...
**Write Targets:**
- dossier.topic_intelligence_vein.audience-demographic-mapper (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M004-001: valid input produces CREATED packet
- TEST-PH1-M004-002: invalid input escalates to WF-900
- TEST-PH1-M004-003: dossier patch is additive only
