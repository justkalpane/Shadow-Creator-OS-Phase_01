...
3. Execute core transformation logic for M-007
...
**Write Targets:**
- dossier.topic_intelligence_vein.algorithm-signal-monitor (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M007-001: valid input produces CREATED packet
- TEST-PH1-M007-002: invalid input escalates to WF-900
- TEST-PH1-M007-003: dossier patch is additive only
