...
3. Execute core transformation logic for M-003
...
**Write Targets:**
- dossier.discovery_vein.keyword-intelligence-miner (append_to_array)
...
**Acceptance Tests:**
- TEST-PH1-M003-001: valid input produces CREATED packet
- TEST-PH1-M003-002: invalid input escalates to WF-900
- TEST-PH1-M003-003: dossier patch is additive only
