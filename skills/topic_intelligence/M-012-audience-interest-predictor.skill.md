# SKL-PH1-AUDIENCE-INTEREST-PREDICTOR

## 1. Skill Identity
- **Skill ID:** M-012
- **Skill Name:** Audience Interest Predictor
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-012 (Audience Interest Predictor). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** audience-interest-predictor_executor
...
- **Downstream Handoff:** audience-interest-predictor_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-012
...
```json
{
  "instance_id": "M-012-[timestamp]",
  "artifact_family": "audience-interest-predictor_packet",
  ...
  "payload": {
    "skill_id": "M-012",
    "skill_name": "Audience Interest Predictor",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.topic_intelligence_vein.audience-interest-predictor (append_to_array)
...
**Writes:**
- dossier.topic_intelligence_vein.audience-interest-predictor (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M012-001: valid input produces CREATED packet
- TEST-PH1-M012-002: invalid input escalates to WF-900
- TEST-PH1-M012-003: dossier patch is additive only
