# SKL-PH1-CULTURAL-CONTEXT-ANALYZER

## 1. Skill Identity
- **Skill ID:** M-015
- **Skill Name:** Cultural Context Analyzer
- **Version:** 1.0.0
...
## 2. Purpose
Runtime-ready canonical skill artifact for M-015 (Cultural Context Analyzer). This specification follows repository DNA law and enforces deterministic execution, packet lineage, governance-safe escalation, and patch-only mutation discipline.

## 3. DNA Injection
- **Role Definition:** cultural-context-analyzer_executor
...
- **Downstream Handoff:** cultural-context-analyzer_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-015
...
```json
{
  "instance_id": "M-015-[timestamp]",
  "artifact_family": "cultural-context-analyzer_packet",
  ...
  "payload": {
    "skill_id": "M-015",
    "skill_name": "Cultural Context Analyzer",
    "result": {}
  }
}
```
...
**Write Targets:**
- dossier.topic_intelligence_vein.cultural-context-analyzer (append_to_array)
...
**Writes:**
- dossier.topic_intelligence_vein.cultural-context-analyzer (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M015-001: valid input produces CREATED packet
- TEST-PH1-M015-002: invalid input escalates to WF-900
- TEST-PH1-M015-003: dossier patch is additive only
