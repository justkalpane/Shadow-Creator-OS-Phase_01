# SKL-PH1-REPUTATION-MONITOR

## 1. Skill Identity
- **Skill ID:** M-110
- **Skill Name:** Reputation Monitor
- **Version:** 1.0.0
...
## 2. Purpose
Skill artifact for M-110 (Reputation Monitor), generated using the latest repository skill DNA template and runtime contract. This skill preserves the same structure, routing semantics, escalation behavior, and mutation law as the current compliant skills.

## 3. DNA Injection
- **Role Definition:** reputation-monitor_executor
...
- **Downstream Handoff:** reputation-monitor_packet -> downstream workflow chain
...
3. Execute core transformation logic for M-110
...
```json
{
  "instance_id": "M-110-[timestamp]",
  "artifact_family": "reputation-monitor_packet",
  ...
  "payload": {
    "skill_id": "M-110",
    "skill_name": "Reputation Monitor",
    "result": {}
  }
}
```
**Write Targets:**
- dossier.governance_vein.reputation-monitor (append_to_array)
...
**Writes:**
- dossier.governance_vein.reputation-monitor (append_only)
...
**Acceptance Tests:**
- TEST-PH1-M110-001: valid input produces CREATED packet
- TEST-PH1-M110-002: invalid input escalates to WF-900
- TEST-PH1-M110-003: dossier patch is additive only
