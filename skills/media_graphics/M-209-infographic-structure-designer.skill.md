# SKL-PH3A-M-209-INFOGRAPHIC_STRUCTURE_DESIGNER

## 1. Skill Identity
- Skill ID: M-209
- Skill Name: Infographic Structure Designer
- Legacy Alias (Compatibility): Infographic Data Visualizer
- Alias Names: Infographic Data Visualizer
...
## 2. Purpose
Design infographic structure and data visualization specifications with narrative sequencing.
...
- Upstream Dependencies: design_brief (from M-201), infographic_script (from M-126), data_claims (from M-015)
- Upstream Skill IDs: M-201, M-126, M-015
- Downstream Consumers: M-210 Animation and Transition Specifier
- Downstream Skill IDs: M-210
...
STEP 3: Load deterministic graphics policy profile for Infographic Structure Designer.
...
STEP 5: Generate primary output payload field chart_specifications.
...
STEP 8: Assemble typed output packet data_visualization_packet.
STEP 9: Append packet to dossier.media_vein.infographic_structure_designer and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-210 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: data_visualization_packet
- JSON Schema Reference: schemas/packets/data_visualization_packet.schema.json
- Dossier Write Target: dossier.media_vein.infographic_structure_designer
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-209-[timestamp]-[instance]",
  "artifact_family": "data_visualization_packet",
  ...
  "payload": {
    "skill_id": "M-209",
    "skill_name": "Infographic Structure Designer",
    "primary_output": {
      "chart_specifications": "[artifact]"
    },
    "routing": {
      "on_success": "M-210",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3A-M-209-001: Valid required inputs produce deterministic data_visualization_packet output
- TEST-PH3A-M-209-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3A-M-209-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3A-M-209-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3A-M-209-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3A-M-209-006: Primary output field chart_specifications is present and non-empty
- TEST-PH3A-M-209-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3A-M-209-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3A-M-209-009: Dossier writes target only dossier.media_vein.infographic_structure_designer
- TEST-PH3A-M-209-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3A-M-209-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3A-M-209-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3A-M-209-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3A-M-209-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3A-M-209-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3A-M-209-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3A-M-209-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3A-M-209-018: Acceptance gate fails closed when governance metadata is incomplete
