# SKL-PH3A-M-201-VISUAL_DESIGN_BRIEF_GENERATOR

## 1. Skill Identity
- Skill ID: M-201
- Skill Name: Visual Design Brief Generator
- Legacy Alias (Compatibility): Design Brief Generator
- Alias Names: Design Brief Generator
...
## 2. Purpose
Generate comprehensive design brief from script artifacts for deterministic media design execution.
...
- Upstream Dependencies: script_variants (from M-130), brand_guidelines, audience_profile
- Upstream Skill IDs: M-130
- Downstream Consumers: M-202 through M-215 (all graphics skills)
- Downstream Skill IDs: M-202, M-203, M-204, M-205, M-206, M-207, M-208, M-209, M-210, M-211, M-212, M-213, M-214, M-215
...
STEP 3: Load deterministic graphics policy profile for Visual Design Brief Generator.
...
STEP 5: Generate primary output payload field visual_direction.
...
STEP 8: Assemble typed output packet design_brief_packet.
STEP 9: Append packet to dossier.media_vein.visual_design_brief_generator and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-202 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: design_brief_packet
- JSON Schema Reference: schemas/packets/design_brief_packet.schema.json
- Dossier Write Target: dossier.media_vein.visual_design_brief_generator
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-201-[timestamp]-[instance]",
  "artifact_family": "design_brief_packet",
  ...
  "payload": {
    "skill_id": "M-201",
    "skill_name": "Visual Design Brief Generator",
    "primary_output": {
      "visual_direction": "[artifact]"
    },
    "routing": {
      "on_success": "M-202",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3A-M-201-001: Valid required inputs produce deterministic design_brief_packet output
- TEST-PH3A-M-201-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3A-M-201-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3A-M-201-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3A-M-201-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3A-M-201-006: Primary output field visual_direction is present and non-empty
- TEST-PH3A-M-201-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3A-M-201-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3A-M-201-009: Dossier writes target only dossier.media_vein.visual_design_brief_generator
- TEST-PH3A-M-201-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3A-M-201-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3A-M-201-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3A-M-201-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3A-M-201-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3A-M-201-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3A-M-201-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3A-M-201-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3A-M-201-018: Acceptance gate fails closed when governance metadata is incomplete
