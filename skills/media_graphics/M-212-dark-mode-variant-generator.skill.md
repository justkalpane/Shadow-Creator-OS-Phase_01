# SKL-PH3A-M-212-DARK_MODE_VARIANT_GENERATOR

## 1. Skill Identity
- Skill ID: M-212
- Skill Name: Dark Mode Variant Generator
- Legacy Alias (Compatibility): Dark Mode Variant Generator
- Alias Names: none
...
## 2. Purpose
Generate dark-mode variants with contrast safety and readability verification.
...
- Upstream Dependencies: color_palette (from M-202), all graphics outputs
- Upstream Skill IDs: M-202, M-201, M-203, M-204, M-205, M-206, M-207, M-208, M-209, M-210, M-211
- Downstream Consumers: M-213 Print-Ready Format Converter
- Downstream Skill IDs: M-213
...
STEP 3: Load deterministic graphics policy profile for Dark Mode Variant Generator.
...
STEP 5: Generate primary output payload field dark_variant_colors.
...
STEP 8: Assemble typed output packet dark_mode_packet.
STEP 9: Append packet to dossier.media_vein.dark_mode_variant_generator and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-213 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: dark_mode_packet
- JSON Schema Reference: schemas/packets/dark_mode_packet.schema.json
- Dossier Write Target: dossier.media_vein.dark_mode_variant_generator
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-212-[timestamp]-[instance]",
  "artifact_family": "dark_mode_packet",
  ...
  "payload": {
    "skill_id": "M-212",
    "skill_name": "Dark Mode Variant Generator",
    "primary_output": {
      "dark_variant_colors": "[artifact]"
    },
    "routing": {
      "on_success": "M-213",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3A-M-212-001: Valid required inputs produce deterministic dark_mode_packet output
- TEST-PH3A-M-212-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3A-M-212-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3A-M-212-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3A-M-212-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3A-M-212-006: Primary output field dark_variant_colors is present and non-empty
- TEST-PH3A-M-212-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3A-M-212-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3A-M-212-009: Dossier writes target only dossier.media_vein.dark_mode_variant_generator
- TEST-PH3A-M-212-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3A-M-212-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3A-M-212-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3A-M-212-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3A-M-212-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3A-M-212-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3A-M-212-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3A-M-212-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3A-M-212-018: Acceptance gate fails closed when governance metadata is incomplete
