# SKL-PH3A-M-208-IMAGE_ASSET_SOURCING_ADVISOR

## 1. Skill Identity
- Skill ID: M-208
- Skill Name: Image Asset Sourcing Advisor
- Legacy Alias (Compatibility): Asset Library Manager
- Alias Names: Asset Library Manager
...
## 2. Purpose
Organize and manage design assets with deterministic versioning and retrieval metadata.
...
- Upstream Dependencies: all graphics outputs (M-201 through M-207)
- Upstream Skill IDs: M-201, M-202, M-203, M-204, M-205, M-206, M-207
- Downstream Consumers: M-209 Infographic Structure Designer
- Downstream Skill IDs: M-209
...
STEP 3: Load deterministic graphics policy profile for Image Asset Sourcing Advisor.
...
STEP 5: Generate primary output payload field asset_inventory.
...
STEP 8: Assemble typed output packet asset_library_packet.
STEP 9: Append packet to dossier.media_vein.image_asset_sourcing_advisor and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-208-[timestamp]-[instance]",
  "artifact_family": "asset_library_packet",
  ...
  "payload": {
    "skill_id": "M-208",
    "skill_name": "Image Asset Sourcing Advisor",
    "primary_output": {
      "asset_inventory": "[artifact]"
    },
    "routing": {
      "on_success": "M-209",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3A-M-208-001: Valid required inputs produce deterministic asset_library_packet output
- TEST-PH3A-M-208-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3A-M-208-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3A-M-208-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3A-M-208-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3A-M-208-006: Primary output field asset_inventory is present and non-empty
- TEST-PH3A-M-208-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3A-M-208-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3A-M-208-009: Dossier writes target only dossier.media_vein.image_asset_sourcing_advisor
- TEST-PH3A-M-208-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3A-M-208-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3A-M-208-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3A-M-208-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3A-M-208-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3A-M-208-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3A-M-208-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3A-M-208-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3A-M-208-018: Acceptance gate fails closed when governance metadata is incomplete
