# SKL-PH3B-M-224-TITLE_CARD_GENERATOR

## 1. Skill Identity
- Skill ID: M-224
- Skill Name: Title Card Generator
- Legacy Alias (Compatibility): Title & Text Overlay Designer
- Alias Names: Title & Text Overlay Designer
...
## 2. Purpose
Design title cards, text overlays, and caption timing specifications.
...
- Upstream Dependencies: script (from M-110/M-120), typography (from M-203), design_brief (from M-201)
- Upstream Skill IDs: M-110, M-120, M-203, M-201
- Downstream Consumers: M-225 Thumbnail Designer
- Downstream Skill IDs: M-225
...
STEP 3: Load deterministic video policy profile for Title Card Generator.
...
STEP 5: Generate primary output payload field title_designs.
...
STEP 8: Assemble typed output packet title_text_packet.
STEP 9: Append packet to dossier.media_vein.title_card_generator and append se_packet_index row.
STEP 10: Emit deterministic routing decision to M-225 or WF-900/WF-021.

## 7. Outputs
- Output Packet Family: title_text_packet
- JSON Schema Reference: schemas/packets/title_text_packet.schema.json
- Dossier Write Target: dossier.media_vein.title_card_generator
- se_packet_index Registration: required append row with lineage and audit metadata

~~~json
{
  "instance_id": "M-224-[timestamp]-[instance]",
  "artifact_family": "title_text_packet",
  ...
  "payload": {
    "skill_id": "M-224",
    "skill_name": "Title Card Generator",
    "primary_output": {
      "title_designs": "[artifact]"
    },
    "routing": {
      "on_success": "M-225",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3B-M-224-001: Valid required inputs produce deterministic title_text_packet output
- TEST-PH3B-M-224-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3B-M-224-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3B-M-224-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3B-M-224-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3B-M-224-006: Primary output field title_designs is present and non-empty
- TEST-PH3B-M-224-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3B-M-224-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3B-M-224-009: Dossier writes target only dossier.media_vein.title_card_generator
- TEST-PH3B-M-224-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3B-M-224-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3B-M-224-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3B-M-224-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3B-M-224-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3B-M-224-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3B-M-224-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3B-M-224-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3B-M-224-018: Acceptance gate fails closed when governance metadata is incomplete
