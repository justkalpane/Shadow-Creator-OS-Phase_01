# SKL-PH3B-M-225-THUMBNAIL_DESIGNER

## 1. Skill Identity
- Skill ID: M-225
- Skill Name: Thumbnail Designer
- Legacy Alias (Compatibility): Thumbnail Optimizer
- Alias Names: Thumbnail Optimizer
...
## 2. Purpose
Design video thumbnails optimized for engagement with deterministic variant criteria.
...
- Upstream Dependencies: design_brief (from M-201), key_visuals
- Upstream Skill IDs: M-201
- Downstream Consumers: M-226 Video SEO Optimizer
- Downstream Skill IDs: M-226
...
STEP 3: Load deterministic video policy profile for Thumbnail Designer.
...
STEP 5: Generate primary output payload field thumbnail_designs.
...
STEP 8: Assemble typed output packet thumbnail_packet.
STEP 9: Append packet to dossier.media_vein.thumbnail_designer and append se_packet_index row.
...
~~~json
{
  "instance_id": "M-225-[timestamp]-[instance]",
  "artifact_family": "thumbnail_packet",
  ...
  "payload": {
    "skill_id": "M-225",
    "skill_name": "Thumbnail Designer",
    "primary_output": {
      "thumbnail_designs": "[artifact]"
    },
    "routing": {
      "on_success": "M-226",
      "on_error": "WF-900",
...
## 12. Validation/Done
**Test Cases**
- TEST-PH3B-M-225-001: Valid required inputs produce deterministic thumbnail_packet output
- TEST-PH3B-M-225-002: Missing dossier_id routes to WF-900 with explicit validation details
- TEST-PH3B-M-225-003: Missing route_id routes to WF-900 without packet emission
- TEST-PH3B-M-225-004: Missing required upstream packet fails closed and escalates to WF-900
- TEST-PH3B-M-225-005: Lineage references are preserved for all upstream dependencies
- TEST-PH3B-M-225-006: Primary output field thumbnail_designs is present and non-empty
- TEST-PH3B-M-225-007: Deterministic logic yields same output structure for identical input state
- TEST-PH3B-M-225-008: Schema validation rejects untyped payload prior to dossier mutation
- TEST-PH3B-M-225-009: Dossier writes target only dossier.media_vein.thumbnail_designer
- TEST-PH3B-M-225-010: Mutation uses append_to_array and never overwrites prior data
- TEST-PH3B-M-225-011: se_packet_index append row includes lineage_reference and instance_id
- TEST-PH3B-M-225-012: Replay branch routes to WF-021 for remodify requests
- TEST-PH3B-M-225-013: Escalation branch routes to WF-900 for validation or policy failures
- TEST-PH3B-M-225-014: Output packet includes timestamp, writer_id, skill_id, instance_id, schema_version
- TEST-PH3B-M-225-015: Forbidden mutation attempt is blocked and audited
- TEST-PH3B-M-225-016: Downstream routing hints are registry-bound and deterministic
- TEST-PH3B-M-225-017: Audit entry includes operation, route_id, source packet, and confidence markers
- TEST-PH3B-M-225-018: Acceptance gate fails closed when governance metadata is incomplete
